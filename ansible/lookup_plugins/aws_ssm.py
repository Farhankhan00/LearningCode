...
class LookupModule(LookupBase):
    def run(self, terms, variables=None, boto_profile=None, aws_profile=None,
        ...
        if region is None:
            ...
            elif json.load(urlopen('http://169.254.169.254/latest/dynamic/instance-identity/document'))['region']:
                region = json.load(urlopen('http://169.254.169.254/latest/dynamic/instance-identity/document'))['region']
